...
def check_basic_build_state(container_id, docker_client):
    assert check_file_exists(container_id, '/sti-fake/prepare-invoked', docker_client)
    assert check_file_exists(container_id, '/sti-fake/run-invoked', docker_client)
...
def test_basic_build():
    ...
    test_image_tag = build_source_image('sti-fake', docker_client)

    sti_build(test_image_tag, app_source, sti_build_tag)
    container_id = run_sti_product(sti_build_tag, docker_client)
